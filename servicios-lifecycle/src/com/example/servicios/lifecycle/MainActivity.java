package com.example.servicios.lifecycle;
...
public class MainActivity extends Activity {
	...
	static public class MyThread extends Thread {
		...
		public void run() {
			try {
				downloadBitmap = downloadBitmap("http://t3.gstatic.com/images?q=tbn:ANd9GcRoV0Qp0UP-qX4Tv8ikySGPkaAyXSfSuRebCWlSWPkw4HP03yhxCQ&t=1");
